...
# ==============================================================================
# CELL 3: Data Quality Validation (NEW!)
# ==============================================================================
...
from correlation_analysis_csv_decimal import generate_data_quality_report, clean_data_quality_issues

# Run comprehensive quality checks BEFORE merging
print("\n🔍 Checking CEI data quality...")
...
# NOTE: If you ran automatic cleaning above, cei_df and bei_df are already cleaned
# Otherwise, the CSVs will be loaded fresh
...
print("\n🔍 Final data quality check on merged dataset...")
