...
def generate_preventable_revisions_report(
    ...
    *,
    ...
    Grouped by PRGRM_NAME, PMM_Program_ID, and FM_REPORTING_MONTH
    """
    required = [
        "CHG_ACTVTY_NUM",
        "RSN_FOR_CHG_CODE_MJR",
    ...
    agg = (
        ...
        .groupby(["PRGRM_NAME", "PMM_Program_ID", "FM_REPORTING_MONTH"], as_index=False)
        .agg(
...
def make_month_filter_sql(base_sql: str, *, month: str) -> Tuple[str, Sequence[Any]]:
    """Add a filter for a specific fiscal reporting month."""
