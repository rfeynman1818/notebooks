...
try:
    ...
    with h5py.File(config["baseline_path"], 'r') as hf:
        # Load the embeddings (E) and labels (Y) arrays
...
# compute_window_distribution_distances is the only function that appears to take the HDF5 path.
...
# The distance index corresponds to the batch distribution (full-dataset drift)
